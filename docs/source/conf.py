...
version = pyCHX.__version__
# The full version, including alpha/beta/rc tags.
release = pyCHX.__version__
...
# Permit strict documentation builds in network-isolated environments while
# retaining external cross-reference inventories in normal CI builds.
if os.environ.get("PYCHX_DOCS_OFFLINE"):
    intersphinx_mapping = {}
